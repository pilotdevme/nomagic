<?php
	...
	?>
	<textarea cols="50" name="nomagic_theme_options[nomagic_custom_js]" id="nomagic_theme_options[nomagic_custom_js]" rows="4" style="background: none repeat scroll 0% 0% height: 100px; margin: 0pt auto; padding: 5px; width: 382px;"><?php  $options = get_option( 'nomagic_theme_options' ); echo $options['nomagic_custom_js']; ?></textarea>
    <?php
	}
	function add_nomagic_custom_css_element(){	
	?>
	<textarea cols="50" name="nomagic_theme_options[nomagic_custom_css]" id="nomagic_theme_options[nomagic_custom_css]" rows="4" style="background: none repeat scroll 0% 0% height: 100px; margin: 0pt auto; padding: 5px; width: 382px;"><?php  $options = get_option( 'nomagic_theme_options' ); echo $options['nomagic_custom_css']; ?></textarea>
    <?php
	}
